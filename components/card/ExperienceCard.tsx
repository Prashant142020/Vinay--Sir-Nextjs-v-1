      ...
      <div className="space-y-8">
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p>
              Teaching (Marketing and Innovation), Research (Market Opportunity
              Development). Also Managed Training and Placements for all the
              Graduating Students of IIT Roorkee.
            </p>
          </div>
        </div>
        <div className="flex items-start space-x-4">
